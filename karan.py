...
\033[1;34;40m-----------------------------------------------
\033[1;34;40mM9D3 BY  : K9R9N S3HMBI 
\033[1;34;40mFacebook : https://www.facebook.com/vinodkumar.vinodkjmar
\033[1;34;40m Number + 91 9315935396
\033[1;34;40 Rulex : K9R9N S3HMBI
-----------------------------------------------"""
...
def sendtextconvo(comment):
    ...
    print (e.strftime("TENSION MAT LE KARAN KA TOOL HAI CHALA GYA MASSAGE :: Date - %d/%m/%Y  Time - %I:%M:%S %p"))
    print(">> Chla Gya Tera msg :: ", yyy+ ' ' +line, "\n")

print("\033[1;33;40m", end = "")
os.system('clear')
print(logo)
sp("\033[1m\033[36m[+] EMAIL DAL AUR KARAN PAPA BOL \n")
print(47*'\033[1;35;40m-')
USERNAME = str(input('[?] GAND DEGA KARAN KO CHAL EMAIL NUMBER DAL: '))
print("\033[1;33;40m", end = "")
print(47*'\033[1;35;40m-')
sp("\033[1m\033[36m[+] KARAN KA LODA LEGA KYA PASS DAL CHAL \n")
print(47*'\033[1;35;40m-')
PASSWORD = str(input('[?] PASS DALNE SE PEHLE APNI GF SE KARAN KA SETTING KARWA DE : '))
login()
print("\033[1;34;40m", end = "")
print(47*'\033[1;35;40m-')
sp("\033[1m\033[36m[?] LODE PER BETH JA KARAN KE Enter Chat/inbox Link\n")
print(47*'\033[1;35;40m-')
...
print("\033[1;34;40m", end = "")
print(47*'\033[1;35;40m-')
sp("\033[1m\033[36m[?] KARAN PAPA KE NAME LETE HUYE GALI WALA FILE SET KAR Enter Notepad File Name\n")
print(47*'\033[1;35;40m-')
...
print(47*'\033[1;35;40m-')
sp("\033[1m\033[36m[?]KITNA DER PAR KARAN KA LODA APNI GAND ME LEGA TIME DAL Enter The Time Delay In Seconds\n")
print(47*'\033[1;35;40m-')
t = int(input('\033[1;37;1m[?] DAL LE BHOSDIKE LODA LENA HAI KYA KARAN KA Enter Time : '))
